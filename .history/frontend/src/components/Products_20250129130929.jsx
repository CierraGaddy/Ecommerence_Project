...
const Products = () => {
  ...
  const [products, setProducts] = useState([]); //React Hook useState holds different states or variables for later use
  ...
  return (
    <div className="products-page">
      ...
      {/* Display Products */}{" "}
      {/* passing props with product info to components */}
